  ...
  implements zzrn
{
  ...
  {
    Account localAccount = zzahz.zzqq();
    ...
    return new ResolveAccountRequest(localAccount, zzale.intValue(), localGoogleSignInAccount);
  }
  ...
  {
    String str = zzahz.zzqv();
    if (!getContext().getPackageName().equals(str)) {
      zzbgU.putString("com.google.android.gms.signin.internal.realClientPackageName", zzahz.zzqv());
    }
    return zzbgU;
  }
}
