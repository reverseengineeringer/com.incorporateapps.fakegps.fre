  ...
  implements Parcelable.Creator
{
  static void zza(Barcode.PersonName paramPersonName, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 2, formattedName, false);
    zzb.zza(paramParcel, 3, pronunciation, false);
    zzb.zza(paramParcel, 4, prefix, false);
    zzb.zza(paramParcel, 5, first, false);
    zzb.zza(paramParcel, 6, middle, false);
    zzb.zza(paramParcel, 7, last, false);
    zzb.zza(paramParcel, 8, suffix, false);
...
/* Location:
 * Qualified Name:     com.google.android.gms.vision.barcode.zzi
