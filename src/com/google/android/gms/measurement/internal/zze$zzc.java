  ...
  extends SQLiteOpenHelper
{
  ...
  private void zza(SQLiteDatabase paramSQLiteDatabase, String paramString1, String paramString2, String paramString3, Map paramMap)
  {
    ...
    {
      zzaVH.zzAo().zzCE().zzj("Failed to verify columns on table that was just created", paramString1);
  ...
  private boolean zza(SQLiteDatabase paramSQLiteDatabase, String paramString)
  {
    ...
    //   67: astore_1
    //   68: aload_0
    //   69: getfield 10	com/google/android/gms/measurement/internal/zze$zzc:zzaVH	Lcom/google/android/gms/measurement/internal/zze;
    //   72: invokevirtual 36	com/google/android/gms/measurement/internal/zze:zzAo	()Lcom/google/android/gms/measurement/internal/zzp;
    //   75: invokevirtual 140	com/google/android/gms/measurement/internal/zzp:zzCF	()Lcom/google/android/gms/measurement/internal/zzp$zza;
    //   78: ldc -114
    //   80: aload_2
    //   81: aload 5
    //   83: invokevirtual 146	com/google/android/gms/measurement/internal/zzp$zza:zze	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    //   86: aload 4
    //   88: ifnull +10 -> 98
    //   91: aload 4
  ...
  {
    if (!zze.zza(zzaVH).zzv(zzaVH.zzCp().zzBN())) {
    ...
    {
      zze.zza(zzaVH).start();
      zzaVH.zzAo().zzCE().zzfg("Opening the database failed, dropping and recreating it");
      Object localObject = zze.zzb(zzaVH);
      zzaVH.getContext().getDatabasePath((String)localObject).delete();
      try
      {
      ...
      {
        zzaVH.zzAo().zzCE().zzj("Failed to open freshly created database", localSQLiteException2);
