...
public final class zzk
{
  ...
  public zzk(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    for (zzuo = zzz(paramAttributeSet);; zzuo = zzz(str))
    {
      zzpS = paramContext.getString(R.styleable.AdsAttrs_adUnitId);
      if (!TextUtils.isEmpty(zzpS)) {
        return;
      }
  ...
  public final AdSize[] zzj(boolean paramBoolean)
  {
    if ((!paramBoolean) && (zzuo.length != 1)) {
