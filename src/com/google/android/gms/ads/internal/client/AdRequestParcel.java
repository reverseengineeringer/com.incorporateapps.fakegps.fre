  ...
  implements SafeParcelable
{
  ...
  {
    return zzw.hashCode(new Object[] { Integer.valueOf(versionCode), Long.valueOf(zztC), extras, Integer.valueOf(zztD), zztE, Boolean.valueOf(zztF), Integer.valueOf(zztG), Boolean.valueOf(zztH), zztI, zztJ, zztK, zztL, zztM, zztN, zztO, zztP, zztQ, Boolean.valueOf(zztR) });
  }
