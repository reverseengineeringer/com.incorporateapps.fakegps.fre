  ...
  implements SafeParcelable
{
  ...
  {
    versionCode = 1;
    zzvd = paramSearchAdRequest.getAnchorTextColor();
    backgroundColor = paramSearchAdRequest.getBackgroundColor();
    zzve = paramSearchAdRequest.getBackgroundGradientBottom();
    zzvf = paramSearchAdRequest.getBackgroundGradientTop();
    zzvg = paramSearchAdRequest.getBorderColor();
    zzvh = paramSearchAdRequest.getBorderThickness();
    zzvi = paramSearchAdRequest.getBorderType();
    zzvj = paramSearchAdRequest.getCallButtonColor();
    zzvk = paramSearchAdRequest.getCustomChannels();
    zzvl = paramSearchAdRequest.getDescriptionTextColor();
    zzvm = paramSearchAdRequest.getFontFace();
    zzvn = paramSearchAdRequest.getHeaderTextColor();
    zzvo = paramSearchAdRequest.getHeaderTextSize();
    zzvp = paramSearchAdRequest.getQuery();
  }
