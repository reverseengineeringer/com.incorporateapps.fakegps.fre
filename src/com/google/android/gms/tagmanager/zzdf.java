...
public class zzdf
{
  ...
  public static zzag.zza zzR(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if ((paramObject instanceof List))
      {
        ...
        zzjy = ((zzag.zza[])((List)paramObject).toArray(new zzag.zza[0]));
      }
      else if ((paramObject instanceof Map))
      {
        ...
        zzjz = ((zzag.zza[])((List)paramObject).toArray(new zzag.zza[0]));
        zzjA = ((zzag.zza[])((List)localObject2).toArray(new zzag.zza[0]));
      }
      else if (zzS(paramObject))
      {
        type = 1;
        zzjx = paramObject.toString();
      }
      else if (zzT(paramObject))
      {
        type = 6;
        zzjD = zzU(paramObject);
      }
      else
      {
        if (!(paramObject instanceof Boolean)) {
        ...
        type = 8;
        zzjE = ((Boolean)paramObject).booleanValue();
      }
    }
  ...
  public static Object zzl(zzag.zza paramzza)
  {
    ...
    case 1: 
      return zzjx;
    case 2: 
      localObject1 = new ArrayList(zzjy.length);
      paramzza = zzjy;
      j = paramzza.length;
      while (i < j)
      {
    ...
    case 3: 
      ...
      localObject1 = new HashMap(zzjA.length);
      i = k;
      while (i < zzjz.length)
      {
        localObject2 = zzl(zzjz[i]);
        Object localObject3 = zzl(zzjA[i]);
