  ...
  implements Parcelable.Creator
{
  static void zza(PersonEntity.CoverEntity paramCoverEntity, Parcel paramParcel, int paramInt)
  {
    ...
    if (localSet.contains(Integer.valueOf(2))) {
      zzb.zza(paramParcel, 2, zzbgg, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(3))) {
      zzb.zza(paramParcel, 3, zzbgh, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(4))) {
      zzb.zzc(paramParcel, 4, zzbgi);
    }
...
/* Location:
 * Qualified Name:     com.google.android.gms.plus.internal.model.people.zzc
