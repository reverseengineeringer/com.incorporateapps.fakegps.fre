  ...
  implements Parcelable.Creator
{
  static void zza(PersonEntity.UrlsEntity paramUrlsEntity, Parcel paramParcel, int paramInt)
  {
    ...
    if (localSet.contains(Integer.valueOf(4))) {
      zzb.zza(paramParcel, 4, mValue, true);
    }
    if (localSet.contains(Integer.valueOf(5))) {
      zzb.zza(paramParcel, 5, zzaUO, true);
    }
    if (localSet.contains(Integer.valueOf(6))) {
      zzb.zzc(paramParcel, 6, zzabB);
    }
...
/* Location:
 * Qualified Name:     com.google.android.gms.plus.internal.model.people.zzj
