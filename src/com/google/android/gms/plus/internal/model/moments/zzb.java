  ...
  implements Parcelable.Creator
{
  static void zza(MomentEntity paramMomentEntity, Parcel paramParcel, int paramInt)
  {
    ...
    if (localSet.contains(Integer.valueOf(2))) {
      com.google.android.gms.common.internal.safeparcel.zzb.zza(paramParcel, 2, zzyv, true);
    }
    if (localSet.contains(Integer.valueOf(4))) {
      com.google.android.gms.common.internal.safeparcel.zzb.zza(paramParcel, 4, zzbfI, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(5))) {
      com.google.android.gms.common.internal.safeparcel.zzb.zza(paramParcel, 5, zzbfA, true);
    }
    if (localSet.contains(Integer.valueOf(6))) {
      com.google.android.gms.common.internal.safeparcel.zzb.zza(paramParcel, 6, zzbfJ, paramInt, true);
    }
    if (localSet.contains(Integer.valueOf(7))) {
      com.google.android.gms.common.internal.safeparcel.zzb.zza(paramParcel, 7, zzJN, true);
    }
...
/* Location:
 * Qualified Name:     com.google.android.gms.plus.internal.model.moments.zzb
