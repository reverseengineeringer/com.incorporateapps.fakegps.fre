  ...
  implements Parcelable.Creator
{
  static void zza(SubscribeRequest paramSubscribeRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 5, zzbcZ, paramInt, false);
    zzb.zza(paramParcel, 6, zzbda, paramInt, false);
    zzb.zzc(paramParcel, 7, zzbdb);
    zzb.zza(paramParcel, 8, zzbbF, false);
    zzb.zza(paramParcel, 9, zzbco, false);
    zzb.zza(paramParcel, 10, zzbdc, false);
    zzb.zza(paramParcel, 11, zzbbG);
    zzb.zza(paramParcel, 12, paramSubscribeRequest.zzEI(), false);
    zzb.zza(paramParcel, 13, zzbbH);
    zzb.zza(paramParcel, 14, zzbcs, paramInt, false);
...
/* Location:
 * Qualified Name:     com.google.android.gms.nearby.messages.internal.zzs
