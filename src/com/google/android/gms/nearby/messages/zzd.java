  ...
  implements Parcelable.Creator
{
  static void zza(Strategy paramStrategy, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 1, zzbbL);
    zzb.zzc(paramParcel, 1000, mVersionCode);
    zzb.zzc(paramParcel, 2, zzbbM);
    zzb.zzc(paramParcel, 3, zzbbN);
    zzb.zza(paramParcel, 4, zzbbO);
...
/* Location:
 * Qualified Name:     com.google.android.gms.nearby.messages.zzd
