...
public class zznu
{
  ...
  static
  {
    AGGREGATE_INPUT_TYPES = Collections.unmodifiableSet(new HashSet(Arrays.asList(new String[] { zzayDname, zzayFname, zzayGname, zzayQname, zzayEname, zzayNname, zzayOname, zzazcname, zzaySname, zzayAname, zzayYname })));
    ...
    zza(localHashMap, localHashSet1, zznu.zza.zzazx);
    zza(localHashMap, localHashSet2, zznu.zza.zzazy);
    zza(localHashMap, localHashSet3, zznu.zza.zzazz);
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put(zzayDname, Collections.singletonList(zzaze));
    localHashMap.put(zzayFname, Collections.singletonList(zzazi));
    localHashMap.put(zzayGname, Collections.singletonList(zzazj));
    localHashMap.put(zzayQname, Collections.singletonList(zzazh));
    localHashMap.put(zzayEname, Collections.singletonList(zzazf));
    localHashMap.put(zzayOname, Collections.singletonList(zzazl));
    localHashMap.put(zzayIname, Collections.singletonList(zzazm));
    localHashMap.put(zzayNname, Collections.singletonList(zzazk));
    localHashMap.put(zzaySname, Collections.singletonList(zzazn));
    localHashMap.put(zzayAname, Collections.singletonList(zzazg));
    localHashMap.put(zzayYname, Collections.singletonList(zzazo));
    return localHashMap;
  }
}
