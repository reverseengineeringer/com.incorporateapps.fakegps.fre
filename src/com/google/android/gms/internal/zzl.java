...
public class zzl
{
  ...
  private final Set zzaa = new HashSet();
  private final PriorityBlockingQueue zzab = new PriorityBlockingQueue();
  private final PriorityBlockingQueue zzac = new PriorityBlockingQueue();
  private zzg[] zzad;
  private zzc zzae;
  private List zzaf = new ArrayList();
    ...
    synchronized (zzaa)
    {
      ...
      synchronized (zzaf)
      {
        ...
        if (((Iterator)localObject2).hasNext()) {
          ((zzl.zza)((Iterator)localObject2).next()).zzg(paramzzk);
        }
      }
    }
    if (paramzzk.zzr()) {}
