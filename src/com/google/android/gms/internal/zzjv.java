  ...
  extends WebChromeClient
{
  ...
  {
    paramBuilder.setMessage(paramString).setPositiveButton(17039370, new zzjv.3(paramJsResult)).setNegativeButton(17039360, new zzjv.2(paramJsResult)).setOnCancelListener(new zzjv.1(paramJsResult)).create().show();
  }
  ...
  private static void zza(Context paramContext, AlertDialog.Builder paramBuilder, String paramString1, String paramString2, JsPromptResult paramJsPromptResult)
  {
    ...
    paramBuilder.setView(localLinearLayout).setPositiveButton(17039370, new zzjv.6(paramJsPromptResult, paramContext)).setNegativeButton(17039360, new zzjv.5(paramJsPromptResult)).setOnCancelListener(new zzjv.4(paramJsPromptResult)).create().show();
  }
  
  private final boolean zziv()
  {
    return (zzr.zzbC().zza(zzpD.getContext().getPackageManager(), zzpD.getContext().getPackageName(), "android.permission.ACCESS_FINE_LOCATION")) || (zzr.zzbC().zza(zzpD.getContext().getPackageManager(), zzpD.getContext().getPackageName(), "android.permission.ACCESS_COARSE_LOCATION"));
  }
  ...
  public final boolean onConsoleMessage(ConsoleMessage paramConsoleMessage)
  {
    ...
    switch (zzjv.7.zzOk[paramConsoleMessage.messageLevel().ordinal()])
    {
    default: 
      zzin.zzaJ(str);
    }
