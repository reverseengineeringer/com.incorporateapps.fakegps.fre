...
public final class zzsv
{
  ...
  public static String zzf(zzsu paramzzsu)
  {
    ...
    try
    {
      zza(null, paramzzsu, new StringBuffer(), localStringBuffer);
      return localStringBuffer.toString();
    }
    catch (IllegalAccessException paramzzsu)
    {
      return "Error printing proto: " + paramzzsu.getMessage();
    }
    catch (InvocationTargetException paramzzsu) {}
    return "Error printing proto: " + paramzzsu.getMessage();
  }
