...
public class InstanceID
{
  ...
  public long getCreationTime()
  {
    if (zzaMU == 0L)
    {
      String str = zzaMQ.get(zzaMT, "cre");
      if (str != null) {
        zzaMU = Long.parseLong(str);
      }
    }
    return zzaMU;
  }
  ...
  public String getToken(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    int i = 1;
    if (zzyD()) {}
    for (Object localObject = null; localObject != null; localObject = zzaMQ.zzi(zzaMT, paramString1, paramString2)) {
    ...
    for (;;)
    {
      ...
      zzaMQ.zza(zzaMT, paramString1, paramString2, paramBundle, zzaMV);
      return paramBundle;
    }
  }
  ...
  public void zzb(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    zzaMQ.zzj(zzaMT, paramString1, paramString2);
