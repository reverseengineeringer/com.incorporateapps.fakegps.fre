  ...
  implements Parcelable.Creator
{
  static void zza(RawBucket paramRawBucket, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 1, zzRD);
    zzb.zzc(paramParcel, 1000, mVersionCode);
    zzb.zza(paramParcel, 2, zzavV);
    zzb.zza(paramParcel, 3, zzavX, paramInt, false);
    zzb.zzc(paramParcel, 4, zzaxf);
    zzb.zzc(paramParcel, 5, zzawg, false);
    zzb.zzc(paramParcel, 6, zzawh);
    zzb.zza(paramParcel, 7, zzawi);
...
/* Location:
 * Qualified Name:     com.google.android.gms.fitness.data.zzn
