  ...
  implements SafeParcelable
{
  ...
  static
  {
    ...
    zzawC = localHashMap;
    localHashMap.put(TYPE_ACTIVITY_SEGMENT, Collections.singletonList(AGGREGATE_ACTIVITY_SUMMARY));
  ...
  {
    return (mName.equals(mName)) && (zzawE.equals(zzawE));
  }
  ...
  {
    int i = zzawE.indexOf(paramField);
    if (i < 0) {
  ...
  {
    return String.format("DataType{%s%s}", new Object[] { mName, zzawE });
  }
