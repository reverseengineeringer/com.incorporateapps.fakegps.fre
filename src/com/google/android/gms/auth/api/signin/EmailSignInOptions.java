  ...
  implements SafeParcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (zzWL.equals(((EmailSignInOptions)paramObject).zzmF())) {
          if (zzWN == null)
          {
          ...
          else
          {
            for (;;)
            {
              ...
              break label101;
              if (!zzWN.equals(((EmailSignInOptions)paramObject).zzmG())) {
                break;
              }
            }
            label79:
            boolean bool = zzWM.equals(((EmailSignInOptions)paramObject).zzmH());
            if (!bool) {}
          }
        }
      }
  ...
  public int hashCode()
  {
    return new zze().zzp(zzWL).zzp(zzWN).zzp(zzWM).zzne();
  }
