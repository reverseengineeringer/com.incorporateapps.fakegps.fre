...
public class zzd
{
  ...
  public static void clearToken(Context paramContext, String paramString)
  {
    ...
    paramString = new zzd.2(paramString, localBundle);
  ...
  public static List getAccountChangeEvents(Context paramContext, int paramInt, String paramString)
  {
    ...
    zzx.zzcE("Calling this from your main thread can lead to deadlock");
    zzad(paramContext);
    paramString = new zzd.3(paramString, paramInt);
  ...
  {
    // Byte code:
    //   0: new 167	com/google/android/gms/common/zza
    //   3: dup
    //   4: invokespecial 168	com/google/android/gms/common/zza:<init>	()V
    //   7: astore_3
    //   8: aload_0
    //   9: invokestatic 174	com/google/android/gms/common/internal/zzl:zzau	(Landroid/content/Context;)Lcom/google/android/gms/common/internal/zzl;
    //   12: astore 4
    //   14: aload 4
    //   16: aload_1
    //   17: aload_3
    //   18: ldc -80
    //   20: invokevirtual 179	com/google/android/gms/common/internal/zzl:zza	(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    //   23: ifeq +58 -> 81
    //   26: aload_2
    //   27: aload_3
    //   28: invokevirtual 183	com/google/android/gms/common/zza:zzoJ	()Landroid/os/IBinder;
    //   31: invokeinterface 189 2 0
    //   36: astore_0
    //   37: aload 4
    //   39: aload_1
    //   40: aload_3
    //   41: ldc -80
    //   43: invokevirtual 193	com/google/android/gms/common/internal/zzl:zzb	(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
    //   46: aload_0
    //   47: areturn
    //   48: astore_0
    //   49: ldc -80
    //   51: ldc -61
    //   53: aload_0
    //   54: invokestatic 201	android/util/Log:i	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   57: pop
    //   58: new 203	java/io/IOException
    //   61: dup
    //   62: ldc -61
    //   64: aload_0
    //   65: invokespecial 206	java/io/IOException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   68: athrow
    //   69: astore_0
    //   70: aload 4
    //   72: aload_1
    //   73: aload_3
    //   74: ldc -80
    //   76: invokevirtual 193	com/google/android/gms/common/internal/zzl:zzb	(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
    //   79: aload_0
    //   80: athrow
    //   81: new 203	java/io/IOException
    //   84: dup
    //   85: ldc -48
    //   87: invokespecial 210	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   90: athrow
    //   91: astore_0
    //   92: goto -43 -> 49
  ...
  public static TokenData zzc(Context paramContext, Account paramAccount, String paramString, Bundle paramBundle)
  {
    ...
    for (paramBundle = new Bundle();; paramBundle = new Bundle(paramBundle))
    {
      ...
      paramAccount = new zzd.1(paramAccount, paramString, paramBundle);
