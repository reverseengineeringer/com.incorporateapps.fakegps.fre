  ...
  implements Parcelable.Creator
{
  static void zza(MaskedWallet paramMaskedWallet, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 4, zzbou, false);
    zzb.zza(paramParcel, 5, zzbor, false);
    zzb.zza(paramParcel, 6, zzbos, paramInt, false);
    zzb.zza(paramParcel, 7, zzbot, paramInt, false);
    zzb.zza(paramParcel, 8, zzbpi, paramInt, false);
    zzb.zza(paramParcel, 9, zzbpj, paramInt, false);
    zzb.zza(paramParcel, 10, zzbov, paramInt, false);
    zzb.zza(paramParcel, 11, zzbow, paramInt, false);
    zzb.zza(paramParcel, 12, zzbox, paramInt, false);
