  ...
  implements Parcelable.Creator
{
  static void zza(PlayLoggerContext paramPlayLoggerContext, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 3, zzbdL);
    zzb.zzc(paramParcel, 4, zzbdM);
    zzb.zza(paramParcel, 5, zzbdN, false);
    zzb.zza(paramParcel, 6, zzbdO, false);
    zzb.zza(paramParcel, 7, zzbdP);
    zzb.zza(paramParcel, 8, zzbdQ, false);
    zzb.zza(paramParcel, 9, zzbdR);
    zzb.zzc(paramParcel, 10, zzbdS);
