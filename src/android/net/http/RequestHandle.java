...
public class RequestHandle
{
  ...
  public RequestHandle(RequestQueue paramRequestQueue, String paramString1, WebAddress paramWebAddress, String paramString2, Map paramMap, InputStream paramInputStream, int paramInt, Request paramRequest)
  {
    throw new RuntimeException("Stub!");
  }
  
  public RequestHandle(RequestQueue paramRequestQueue, String paramString1, WebAddress paramWebAddress, String paramString2, Map paramMap, InputStream paramInputStream, int paramInt, Request paramRequest, Connection paramConnection)
  {
    throw new RuntimeException("Stub!");
  }
  ...
  public boolean setupRedirect(String paramString, int paramInt, Map paramMap)
  {
    throw new RuntimeException("Stub!");
  }
