  ...
  implements DrawerLayout.DrawerListener
{
  ...
  ActionBarDrawerToggle(Activity paramActivity, Toolbar paramToolbar, DrawerLayout paramDrawerLayout, Drawable paramDrawable, int paramInt1, int paramInt2)
  {
    ...
    label198:
    for (mSlider = new ActionBarDrawerToggle.DrawerArrowDrawableToggle(paramActivity, mActivityImpl.getActionBarThemedContext());; mSlider = ((ActionBarDrawerToggle.DrawerToggle)paramDrawable))
    {
      ...
      {
        mActivityImpl = ((ActionBarDrawerToggle.TmpDelegateProvider)paramActivity).getV7DrawerToggleDelegate();
        break;
      }
