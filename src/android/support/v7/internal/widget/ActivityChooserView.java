  ...
  implements ActivityChooserModel.ActivityChooserModelClient
{
  ...
  public ActivityChooserView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    mInitialActivityCount = paramAttributeSet.getInt(R.styleable.ActivityChooserView_initialActivityCount, 4);
    Drawable localDrawable = paramAttributeSet.getDrawable(R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
