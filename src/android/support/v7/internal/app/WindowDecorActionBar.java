  ...
  implements ActionBarOverlayLayout.ActionBarVisibilityCallback
{
  ...
  public WindowDecorActionBar(ActionBarActivity paramActionBarActivity, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {
      mContentView = paramActionBarActivity.findViewById(16908290);
    }
  }
  ...
  public void selectTab(ActionBar.Tab paramTab)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return;
        localFragmentTransaction = mActivity.getSupportFragmentManager().beginTransaction().disallowAddToBackStack();
        break;
  ...
  public ActionMode startActionMode(ActionMode.Callback paramCallback)
  {
    ...
    paramCallback = new WindowDecorActionBar.ActionModeImpl(this, paramCallback);
