  ...
  implements View.OnKeyListener
{
  ...
  public boolean onKey(View paramView, int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    } while ((SearchView.SearchAutoComplete.access$1700(SearchView.access$1300(this$0))) || (!KeyEventCompat.hasNoModifiers(paramKeyEvent)) || (paramKeyEvent.getAction() != 1) || (paramInt != 66));
