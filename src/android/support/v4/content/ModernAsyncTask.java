...
abstract class ModernAsyncTask
{
  ...
  private final FutureTask mFuture = new ModernAsyncTask.3(this, mWorker);
  ...
  {
    sHandler.obtainMessage(1, new ModernAsyncTask.AsyncTaskResult(this, new Object[] { paramObject })).sendToTarget();
    return paramObject;
  }
