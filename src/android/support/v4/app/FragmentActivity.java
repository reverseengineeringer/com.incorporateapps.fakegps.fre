  ...
  extends Activity
{
  ...
  public View onCreateView(String paramString, Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, FragmentActivity.FragmentTag.Fragment);
  ...
  public boolean onPreparePanel(int paramInt, View paramView, Menu paramMenu)
  {
    if ((paramInt == 0) && (paramMenu != null))
    {
      ...
      return super.onPreparePanel(paramInt, paramView, paramMenu) | mFragments.dispatchPrepareOptionsMenu(paramMenu);
    }
  ...
  public final Object onRetainNonConfigurationInstance()
  {
    ...
    if (mAllLoaderManagers != null)
    {
      localObject2 = new LoaderManagerImpl[mAllLoaderManagers.size()];
      mAllLoaderManagers.values().toArray((Object[])localObject2);
      int i = 0;
      k = i;
